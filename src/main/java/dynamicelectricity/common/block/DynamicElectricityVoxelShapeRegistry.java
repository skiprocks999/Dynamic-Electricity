...
public class DynamicElectricityVoxelShapeRegistry {
	...
	public static void init() {
		...
		VoxelShapeRegistry.registerShape(DynamicElectricityBlocks.blockMotorAcHv, hvacmotor, Direction.WEST);
		...
		VoxelShape hvdcmotor = Stream.of(
				...
				Stream.of(
						...
						Stream.of(
								...
								Block.box(1, 5.5, 5.5, 3, 10.5, 10.5)
						//
						).reduce((v1, v2) -> VoxelShapes.or(v1, v2)).get(), Stream.of(
								//
								Stream.of(
										//
										Block.box(8, 1, 12, 14, 2, 14),
		...
		VoxelShapeRegistry.registerShape(DynamicElectricityBlocks.blockMotorDcHv, hvdcmotor, Direction.WEST);
		...
		VoxelShapeRegistry.registerShape(DynamicElectricityBlocks.blockMotorAcLv, lvacmotor, Direction.WEST);
		...
		VoxelShapeRegistry.registerShape(DynamicElectricityBlocks.blockMotorDcLv, lvdcmotor, Direction.WEST);
		...
		VoxelShapeRegistry.registerShape(DynamicElectricityBlocks.blockMotorAcMv, mvacmotor, Direction.WEST);
		...
		VoxelShapeRegistry.registerShape(DynamicElectricityBlocks.blockMotorDcMv, mvdcmotor, Direction.WEST);
