...
public class DynamicElectricityVoxelShapes {
    ...
    public static final VoxelShapeProvider HV_ACMOTOR = VoxelShapeProvider.createDirectional(
            //
            Direction.WEST,
            //
            Stream.of(Block.box(0, 0, 0, 16, 1, 16),
                    //
                    Stream.of(
                            //
    ...
    public static final VoxelShapeProvider HV_DCMOTOR = VoxelShapeProvider.createDirectional(
            //
            Direction.WEST,
            //
            Stream.of(
                    ...
                    Stream.of(
                            ...
                            Stream.of(
                                    ...
                                    Block.box(1, 5.5, 5.5, 3, 10.5, 10.5)
                                    //
                            ).reduce(VoxelShapes::or).get(), Stream.of(
                                    //
                                    Stream.of(
                                            //
                                            Block.box(8, 1, 12, 14, 2, 14),
    ...
    public static final VoxelShapeProvider LV_ACMOTOR = VoxelShapeProvider.createDirectional(
            //
            Direction.WEST,
            //
            Stream.of(
    ...
    public static final VoxelShapeProvider LV_DCMOTOR = VoxelShapeProvider.createDirectional(
            //
            Direction.WEST,
            //
            Stream.of(
    ...
    public static final VoxelShapeProvider MV_ACMOTOR = VoxelShapeProvider.createDirectional(
            //
            Direction.WEST,
            //
            Stream.of(
    ...
    public static final VoxelShapeProvider MV_DCMOTOR = VoxelShapeProvider.createDirectional(
            //
            Direction.WEST,
            //
            Stream.of(
