...
public class DeferredRegisters {
    ...
    static {
    	...
    	ITEMS.register("motorachv", 
    		supplier(new BlockItemDescriptable(blockMotorAcHv, new Item.Properties().group(References.DYELECTAB).maxStackSize(1))));
    	ITEMS.register("motoracmv", 
        	supplier(new BlockItemDescriptable(blockMotorAcMv, new Item.Properties().group(References.DYELECTAB).maxStackSize(1))));
    	ITEMS.register("motoraclv", 
        	supplier(new BlockItemDescriptable(blockMotorAcLv, new Item.Properties().group(References.DYELECTAB).maxStackSize(1))));
    	ITEMS.register("motordchv", 
        	supplier(new BlockItemDescriptable(blockMotorDcHv, new Item.Properties().group(References.DYELECTAB).maxStackSize(1))));
    	ITEMS.register("motordcmv", 
        	supplier(new BlockItemDescriptable(blockMotorDcMv, new Item.Properties().group(References.DYELECTAB).maxStackSize(1))));
    	ITEMS.register("motordclv", 
        	supplier(new BlockItemDescriptable(blockMotorDcLv, new Item.Properties().group(References.DYELECTAB).maxStackSize(1))));
    ...
    public static final RegistryObject<Item> ITEM_GELLUBRICANT = ITEMS.register("gellubricant",
    	supplier(new Item(new Item.Properties().group(References.DYELECTAB))));
    ...
    public static final RegistryObject<Item> ITEM_SHAFTSTEEL = ITEMS.register("shaftsteel",
        supplier(new Item(new Item.Properties().group(References.DYELECTAB).maxStackSize(1))));
    ...
    public static final RegistryObject<Item> ITEM_CONDUCTORBRUSH = ITEMS.register("conductorbrush",
    	supplier(new Item(new Item.Properties().group(References.DYELECTAB).maxDamage(BRUSH_DURABILITY))));
    
    public static final RegistryObject<TileEntityType<TileMotorAcHv>> TILE_MOTORAC_HV = TILES.register("motorachv",
    	() -> new TileEntityType<>(TileMotorAcHv::new ,Sets.newHashSet(blockMotorAcHv),null));
    public static final RegistryObject<TileEntityType<TileMotorAcMv>> TILE_MOTORAC_MV = TILES.register("motoracmc",
    	() -> new TileEntityType<>(TileMotorAcMv::new, Sets.newHashSet(blockMotorAcMv),null));
    public static final RegistryObject<TileEntityType<TileMotorAcLv>> TILE_MOTORAC_LV = TILES.register("motoraclv",
    	() -> new TileEntityType<>(TileMotorAcLv::new,Sets.newHashSet(blockMotorAcLv),null));
    public static final RegistryObject<TileEntityType<TileMotorDcHv>> TILE_MOTORDC_HV = TILES.register("motordchv",
    	() -> new TileEntityType<>(TileMotorDcHv::new,Sets.newHashSet(blockMotorDcHv),null));
    public static final RegistryObject<TileEntityType<TileMotorDcMv>> TILE_MOTORDC_MV = TILES.register("motordcmv",
    	() -> new TileEntityType<>(TileMotorDcMv::new, Sets.newHashSet(blockMotorDcMv),null));
    public static final RegistryObject<TileEntityType<TileMotorDcLv>> TILE_MOTORDC_LV = TILES.register("motordclv",
    	() -> new TileEntityType<>(TileMotorDcLv::new, Sets.newHashSet(blockMotorDcLv),null));
    
    public static final RegistryObject<ContainerType<ContainerMotorAC>> CONTAINER_MOTORAC = CONTAINERS.register
    	("motorac", () -> new ContainerType<>(ContainerMotorAC::new));
    public static final RegistryObject<ContainerType<ContainerMotorDC>> CONTAINER_MOTORDC = CONTAINERS.register
    	("motordc", () -> new ContainerType<>(ContainerMotorDC::new));
