...
public class DynamicElectricityItems {
	...
	public static final RegistryObject<Item> ITEM_DUSTPDSM = ITEMS.register("dustpdsm", () -> new ItemDescriptable(new Item.Properties().tab(References.DYELECTAB), UtilsText.tooltip("dustpdsm").withStyle(ChatFormatting.GRAY)));
