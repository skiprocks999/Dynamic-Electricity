...
public class DynamicElectricityItems {
	...
	public static final RegistryObject<Item> ITEM_DUSTPDSM = ITEMS.register("dustpdsm", () -> new ItemDescriptable(new Item.Properties(), () -> DynamicElectricityCreativeTabs.MAIN, UtilsText.tooltip("dustpdsm").withStyle(TextFormatting.DARK_GRAY)));
